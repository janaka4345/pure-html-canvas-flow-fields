...
export function draw4(ctx) {
  ...
  ctx.lineTo(
    line[0].endX * (count % 100) * 0.01 + 10,
    line[0].endY * (count % 100) * 0.01 + 5
  );
  ctx.lineTo(
    line[0].endX * (count % 100) * 0.01 + 50,
    line[0].endY * (count % 100) * 0.01 + 20
  );
  ctx.lineTo(
    line[0].endX * (count % 100) * 0.01 + 20,
    line[0].endY * (count % 100) * 0.01 + 50
  );
  ctx.lineTo(
    line[0].endX * (count % 100) * 0.01 + 100,
    line[0].endY * (count % 100) * 0.01 + 10
  );
  ctx.stroke();
